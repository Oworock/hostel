...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <h1 class="text-4xl font-bold text-gray-900 mb-8">Create New Room</h1>
    
    <div class="bg-white rounded-lg shadow-md p-8">
        <form method="POST" action="{{ route('manager.rooms.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center space-x-4 pt-6 border-t">
                ...
                <a href="{{ route('manager.rooms.index') }}" class="text-gray-600 hover:text-gray-900 font-medium">
                    Cancel
                </a>
            </div>
        </form>
