...
use App\Http\Controllers\SystemUpdateMaintenanceController;
...
Route::get('/system/update/ping', [SystemUpdateMaintenanceController::class, 'ping'])->name('system.update.ping');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::put('/files/{uploadedFile}', [FileManagerController::class, 'update'])->name('files.update');
        ...
        Route::get('/system/updates/dismiss-notice', [UpdateNoticeController::class, 'dismiss'])->name('updates.dismiss-notice');
    });
