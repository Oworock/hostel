<x-dashboard-layout title="Room Change Requests">
    ...
    <div class="uniform-page">
        <div class="uniform-header">
            <h1 class="text-3xl font-bold text-slate-900 dark:text-slate-100">Room Change Requests</h1>
            <p class="text-slate-600 dark:text-slate-300 mt-1">Review student requests to move to another room in your managed hostels.</p>
        </div>
        ...
        <div class="uniform-grid-2">
            ...
            @empty
                <div class="col-span-full uniform-card p-8 text-center text-slate-600 dark:text-slate-300">No room change requests found.</div>
            @endforelse
        </div>
