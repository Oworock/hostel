                    ...
                    <article class="px-3 sm:px-4 py-3 flex items-start gap-3 border-b border-gray-200 dark:border-gray-700 last:border-b-0">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="mt-2 flex items-center gap-4 whitespace-nowrap">
                                ...
                                <form method="POST" action="{{ route('admin.files.update', $file) }}" enctype="multipart/form-data" class="inline-flex items-center gap-2">
                                    @csrf
                                    @method('PUT')
                                    <input type="file" name="file" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp" required class="text-xs max-w-[160px]">
                                    <button type="submit" class="text-amber-600 hover:underline text-sm">Update File</button>
                                </form>
